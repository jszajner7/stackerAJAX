...
//STEP 2 (getUnanswerd - unanswerd question search) using the input from the user (query) make the API call to get the API call to get the JSON response
//takes a string of semi-colon separated tags to be searched for on StackOverFlow's API
var getUnanswered = function (tags) {
    ...
    $.ajax({
            ...
            data: request,
            dataType: "jsonp", //use jsonp to axvoid cross origin issues
            type: "GET",
        })
        ...
        .done(function (result) { // this waits for the ajax to return with a succesful promise object
            ...
            //$.each is a higher order function.It takes an array and a function as a argument.
...
// STEP 2 (getInspiration - top users search) - using the input from the user (query) make the API call to get the JASON response
...
// STEP 3 (getUnanserd - unanswered questions search) - using the JSON response, populate the relevant part of your HTML with the variable inside the JSON
// This function takes the question object returned by the StackOverflow request and returns new result to be appended to the DOM
...
// STEP 3 (GetInspiration - top users search) - using the Jason response, populate the relevant part of your HTML with the variable inside the JSON
...
//this function takes the results object from StackOverflow and returns the number of results and tags to be appended to the DOM
